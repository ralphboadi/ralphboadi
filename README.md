...
Using these, we assign each customer a segment label (Platinum for customers with sales greater than or equal to $10000, Gold for customer with sales greater than or equal to $5000 , Silver for customers greater than or equal to $1000 sales, Else Bronze for customers with sales less than $1000) based on performance.
